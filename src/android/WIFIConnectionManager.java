package cordova.plugin.wificonnectionmanager;
 ...
 */
public class WIFIConnectionManager extends CordovaPlugin {
    ...
    private static final String ACTION_ON_WIFISETTINGS = "redirectToWIFISettings";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        else if (action.equals(ACTION_ON_WIFISETTINGS)) redirectToWIFISettings(callbackContext);
        else return false;
    ...
    private void redirectToWIFISettings(CallbackContext callbackContext) {
