...
var exec = function (method, args, cb) {
    ...
    window.cordova.exec(onsucces, onerror, 'WIFIConnectionManager', method, args || [])
}

var WIFIConnectionManager = function () {
...
METHODS.forEach(function (method) {
    WIFIConnectionManager.prototype[method] = function () {
        var args = slice.call(arguments)
...
module.exports = new WIFIConnectionManager()